...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4>Energization Report per Barangay | NEA</h4>
            </div>
        </div>
    </div>
</section>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card shadow-none">
            {!! Form::open(['route' => 'serviceConnections.energization-per-brgy', 'method' => 'GET']) !!}
            <div class="card-body">
                <div class="row">
    ...
    <script>
        $(document).ready(function() {
            $('#download').on('click', function(e) {
                e.preventDefault()
                window.location.href = "{{ url('/service_connections/download-energization-per-brgy') }}" + "/" + $('#Month').val() + "/" + $('#Year').val() 
            })
        })
    </script>
@endpush