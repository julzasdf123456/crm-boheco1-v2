...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h4>Ticket Crew Monitoring <span><i class="text-muted" style="font-size: .7em; margin-left: 10px;">For the
                                last 45 days</i></span></h4>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="card shadow-none">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <button class="btn btn-primary btn-sm" id="filter"><i
                                    class="fas fa-filter ico-tab-mini"></i>Filter</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <span class="card-title">
                            <span>
                                <div
                                    style="width: 15px; height: 15px; background-color: #0277bd; display: inline-block; margin-right: 3px;">
                                </div>Received
                            </span>
                            <span style="margin-left: 20px;">
                                <div
                                    style="width: 15px; height: 15px; background-color: #ab47bc; display: inline-block; margin-right: 3px;">
                                </div>Downloaded by Crew
                            </span>
                            <span style="margin-left: 20px;">
                                <div
                                    style="width: 15px; height: 15px; background-color: #f57f17; display: inline-block; margin-right: 3px;">
                                </div>Acted
                            </span>
                            <span style="margin-left: 20px;">
                                <div
                                    style="width: 15px; height: 15px; background-color: #00c853; display: inline-block; margin-right: 3px;">
                                </div>Executed
                            </span>
                            <span style="margin-left: 20px;">
                                <div
                                    style="width: 15px; height: 15px; background-color: #c62828; display: inline-block; margin-right: 3px;">
                                </div>Not Executed/Others
                            </span>
                        </span>
                    </div>
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $.each(res, function(index, element) {
                        // APPEND TO TABLE
                        $('#res-table tbody').append(addRow(res[index]['id'], res[index][
                            'ConsumerName'], res[index]['Name'], res[index]['StationName'], res[
                                index]['created_at'], res[index]['GeoLocation']))
                        ...
                        if (!jQuery.isEmptyObject(res[index]['GeoLocation'])) {
                            ...
                            el.innerHTML +=
                                '<button id="update" class="btn btn-sm" style="margin-left: -10px;" style="margin-left: 10px;"> <span><i class="fas fa-map-marker" style="font-size: 2.3em; color: ' +
                                color + ';"></i></span> </button>'
                            ...
                            el.addEventListener('click', () => {
                                Swal.fire({
                                    ...
                                    html: '<span>TICKET ID: ' + res[index]['id'] +
                                        '</span><br><span>TICKET: ' + res[index][
                                        'Name'] + '</span><br><span>' + 'GPS: ' + res[
                                            index]['GeoLocation'] +
                                        '</span><br><span>' + 'Status: ' + res[index][
                                            'Status'
                                        ] + '</span>',
                                })
                            });
