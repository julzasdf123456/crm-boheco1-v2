...
@push('page_scripts')
    <script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCZmiSxB5WTTdvd-HITv01LZpa2NBmH2Zc&callback=initMap&v=beta&libraries=marker"
    defer
    ></script>
    ...
    <script>
        ...
        function initMap() {
            const myLatLng = { lat: 9.764970, lng: 124.016388 };
                    ...
                    if (jQuery.isEmptyObject(res)) {
                        ...
                        if (jQuery.isEmptyObject(loc)) {
                            ...
                            if (coordinates.length == 2) {
                                ...
                                new google.maps.AdvancedMarkerView({
                                    position: { lat : parseFloat(lati), lng : parseFloat(longi) },
                                    map,
                                    title: "Account No: " + res['AccountNumber'] + " | Consumer Name: " + res['ConsumerName'],
                                });
