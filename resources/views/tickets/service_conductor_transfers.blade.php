...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4>Service Conductor Transfer Report</h4>
            </div>
        </div>
    </div>
</section>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card shadow-none">
            {!! Form::open(['route' => 'tickets.service-conductor-transfers', 'method' => 'GET']) !!}
            <div class="card-body">
                <div class="row">
    ...
    <script>
        $(document).ready(function() {
            $('#download').on('click', function(e) {
                ...
                window.location.href = "{{ url('/tickets/download-service-conductor-transfers/') }}" + "/" + $('#From').val() + "/" + $('#To').val() + "/" + $('#Office').val()
            })
        })
    </script>
@endpush