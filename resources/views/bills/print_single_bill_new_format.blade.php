    ...
    <div class="half" style="float-right; margin-left: 5px;">
        ...
        <table class="bordered" style="width: 100%; margin-top: 2px;">
            ...
            <tr class="no-border-top-bottom">
                ...
                <td class="no-border-top-bottom text-right"></td>
                <td class="no-border-top-bottom text-right">-{{ number_format($bills->Deductions, 2) }}</td>
            </tr>
            <tr class="no-border-top-bottom">
            ...
            <tr class="no-border-top-bottom">
                ...
                <td class="no-border-top-bottom text-right"></td>
                <th class="no-border-top-bottom text-right">{{ Bills::isPenaltyable(Bills::getAccountTypeByType($bills->ConsumerType))==false ? number_format(Bills::getFinalPenalty($bills), 2) : '0' }}</th>
            </tr>
            <tr class="no-border-top-bottom">
                <th class="no-border-top-bottom text-left left-indent">TOTAL AMOUNT DUE After</th>
                <td class="no-border-top-bottom text-right"></td>
                <th class="no-border-top-bottom text-right">{{ Bills::isPenaltyable(Bills::getAccountTypeByType($bills->ConsumerType))==false ? number_format(floatval(Bills::getFinalPenalty($bills)) + floatval($bills->NetAmount), 2) : number_format($bills->NetAmount, 2) }}</th>
            </tr>
        </table>
    </div>
