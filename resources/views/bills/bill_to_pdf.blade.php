        ...
        <div style="padding: 240px 30px 0 30px;">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <p class="no-pads"><span class="text-muted">Meter Number:
                        </span><span>{{ $accountMaster != null ? $accountMaster->MeterNumber : '' }}</span></p>
                    <p class="no-pads"><span class="text-muted">Subscriber Number:
                        </span><span>{{ $bill != null ? $bill->Remarks : '' }}</span></p>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="4" style="padding-right: 25px !important;"><strong>Distribution
                                    Charges</strong></td>
                            <td colspan="4" style="padding-left: 25px !important;"><strong>VAT Charges</strong>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="4" style="padding-right: 25px !important;"><strong>Universal
                                    Charges</strong></td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="4" style="padding-right: 25px !important;"><strong>Pass-Through
                                    Taxes</strong></td>
                            <td></td>
                        </tr>
                        {{-- FRANCHISE TAX --}}
                ...
                <div class="row mt-1">
                    <div class="col-md-4">
                        ...
                        <p class="indent-1 no-pads"><span class="text-muted">WT 2307: </span> <strong>₱
                                {{ number_format($billsDcrRevisionView->Form2307, 2) }}</strong></p>
                    </div>
                    <div class="col-md-8">
                        <p class="no-pads text-sm"><strong>NOTE:</strong>
                            <br>
                            <span>1. AVAILABLE DISCOUNT FIGURE(S) are ONLY applicable to those Commercial and Industrial
                                consumers whose KWH
                                consumptions are greater than 1000, and should be payed before the DUE DATE.</span>
                            <br>
                            <span>2. 2306 & 2307 will be deducted on the current amount due ONLY IF you can provide us
                                the required documents.</span>
                            <br>
                            <span>3. All available deductibles are not automatically deducted on your current bill, not
                                unless you provide us the required documents.</span>
                            @if ($accountMaster->ComputeMode === 'NetMetered')
                                <br>
                                <span>4. For <strong>NET METERED ACCOUNTS</strong>, Per DOE Circular No. 2020-10-002,
                                    Section 6, all net-metering credits must be utilized within one calendar year. Any
                                    remaining balance or excess credits at the end of the calendar year will be
                                    forfeited.</span>
                            @endif
                        </p>
                    </div>
