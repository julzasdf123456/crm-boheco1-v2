    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-7">
            <div class="input-group">
                ...
                {!! Form::text('FirstName', null, ['class' => 'form-control form-control-sm','maxlength' => 300,'maxlength' => 300, 'placeholder' => 'Spouse First Name']) !!}
            </div>
        </div>
    </div> 
</div>
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-7">
            <div class="input-group">
                ...
                {!! Form::text('MiddleName', null, ['class' => 'form-control form-control-sm','maxlength' => 300,'maxlength' => 300, 'placeholder' => 'Spouse Middle Name']) !!}
            </div>
        </div>
    </div> 
</div>
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-7">
            <div class="input-group">
                ...
                {!! Form::text('LastName', null, ['class' => 'form-control form-control-sm','maxlength' => 300,'maxlength' => 300, 'placeholder' => 'Spouse Last Name']) !!}
            </div>
        </div>
    </div> 
</div>
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-7">
            <div class="input-group">
                ...
                {!! Form::select('Gender', ['' => 'Prefer not to state', 'Male' => 'Male', 'Female' => 'Female', 'LGBTQ+' => 'LGBTQ+'], $cond=='new' ? ($memberConsumer->Gender=='Male' ? 'Female' : 'Male') : $memberConsumerSpouse->Gender, ['class' => 'form-control form-control-sm',]) !!}
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-7">
            <div class="input-group">
                ...
                {!! Form::text('Birthdate', null, ['class' => 'form-control form-control-sm']) !!}
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-7">
            <div class="input-group">
                ...
                {!! Form::select('Town', $towns, $cond=='new' ? $memberConsumer->Town : $memberConsumerSpouse->Town, ['class' => 'form-control form-control-sm']) !!}
            </div>
        </div>
    </div>    
</div>
