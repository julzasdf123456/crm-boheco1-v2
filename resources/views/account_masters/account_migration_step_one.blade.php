    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <span>
                        <h4 style="display: inline; margin-right: 15px;"><strong class="text-primary">Step 1.</strong> Account
                            Migration Wizzard</h4>
            ...
            <div class="card shadow-none">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden"
                            value="{{ $serviceConnection != null ? $serviceConnection->DateTimeOfEnergization : null }}"
                            name="ConnectionDate">
                        <input type="hidden" value="{{ date('Y-m-d H:i:s') }}" name="DateEntry">
                        <input type="hidden" value="{{ $crew != null ? substr($crew->StationName, 0, 29) : null }}"
                            name="InstalledBy">
                        <input type="hidden" value="READ" name="BillingStatus">
                        <input type="hidden"
                            value="{{ AccountMaster::getInstallationType($serviceConnection->BuildingType) }}"
                            name="InstallationType">
                        <input type="hidden" value="{{ AccountMaster::getGroupTag($serviceConnection->AccountType) }}"
                            name="GroupTag">
                    ...
                    <input type="hidden" name="Longitude" value="{{ ServiceAccounts::getLongitude($inspection->GeoMeteringPole) }}"/> --}}
                        ...
                        <div class="form-group col-lg-4 col-md-5 col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3">
                                    <button class="btn btn-sm btn-info" id="check-acct-availability">Check
                                        Available</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-lg-3 col-md-3 col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4">
                                    <button class="btn btn-sm btn-info" id="check-sequence-availability">Check
                                        Available</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-lg-2 col-md-3 col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-md-6">
                                    <div class="input-group">
                                        {!! Form::text('Area', $town != null ? $town->Station : $serviceConnection->Town, [
                                            'class' => 'form-control form-control-sm',
                                            'maxlength' => 5,
                                            'required' => true,
                                        ]) !!}
                        ...
                        <div class="form-group col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-4">
                                    <div class="input-group">
                                        {!! Form::text('ConsumerName', $serviceConnection != null ? $serviceConnection->ServiceAccountName : '', [
                                            'class' => 'form-control form-control-sm',
                                            'maxlength' => 600,
                                            'maxlength' => 600,
                                            'required' => true,
                                ...
                                <div class="col-lg-5 col-md-4">
                                    <div class="input-group">
                                        {!! Form::text(
                                            'ConsumerAddress',
                                            ($barangay != null ? $barangay->Barangay : '-') . ', ' . ($town != null ? $town->Town : '-'),
                                            ['class' => 'form-control form-control-sm', 'maxlength' => 600, 'maxlength' => 600],
                                        ) !!}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2">
                                    <div class="input-group">
                                        {!! Form::select('AccountStatus', ['ACTIVE' => 'ACTIVE', 'DISCO' => 'DISCONNECTED'], null, [
                                            'class' => 'form-control form-control-sm',
                                        ]) !!}
                                    </div>
                                </div>
                                    ...
                                    <div class="input-group">
                                        <select class="form-control form-control-sm" name="ConsumerType" id="AccountType">
                                            @foreach ($accountTypes as $item)
                                                <option value="{{ AccountMaster::getTypeByAlias($item->Alias) }}"
                                                    f-name="{{ AccountMaster::getTypeByAlias($item->Alias) }}"
                                                    {{ $item->id == $serviceConnection->AccountType ? 'selected' : '' }}>
                                                    {{ $item->AccountType }} ({{ $item->Alias }})</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="form-group col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2">
                                    <div class="input-group">
                                        {!! Form::text('Neighbor1', $inspection->FirstNeighborName, [
                                            'class' => 'form-control form-control-sm',
                                            'readonly' => true,
                                        ]) !!}
                                    </div>
                                ...
                                <div class="col-lg-2 col-md-2">
                                    <div class="input-group">
                                        {!! Form::text('Neighbor1Meter', $inspection->FirstNeighborMeterSerial, [
                                            'class' => 'form-control form-control-sm',
                                            'readonly' => true,
                                        ]) !!}
                                    </div>
                                ...
                                <div class="col-lg-2 col-md-2">
                                    <div class="input-group">
                                        {!! Form::text('Neighbor2', $inspection->SecondNeighborName, [
                                            'class' => 'form-control form-control-sm',
                                            'readonly' => true,
                                        ]) !!}
                                    </div>
                                ...
                                <div class="col-lg-2 col-md-2">
                                    <div class="input-group">
                                        {!! Form::text('Neighbor2Meter', $inspection->SecondNeighborMeterSerial, [
                                            'class' => 'form-control form-control-sm',
                                            'readonly' => true,
                                        ]) !!}
                                    </div>
                        ...
                        <div class="form-group col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2">
                                    <div class="input-group">
                                        {!! Form::text('Email', $serviceConnection->EmailAddress, ['class' => 'form-control form-control-sm']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2 col-md-2">
                                    <div class="input-group">
                                        {!! Form::text('ContactNumber', $serviceConnection->ContactNumber, ['class' => 'form-control form-control-sm']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('serviceConnections.show', [$serviceConnection->id]) }}"
                        class="btn btn-success btn-sm" target="_blank">View Application Info</a>

                    <button id="bapa-member" class="btn btn-default btn-sm" style="margin-left: 20px;">BAPA
                        Member</button>
            ...
            <div class="card shadow-none">
                <div class="card-header">
                    <span>
                        ...
                        Barangay
                        <input type="text" class="form-control form-control-sm" style="width: 180px; display: inline;"
                            id="brgy" value="{{ $barangay != null ? $barangay->Barangay : '' }}">
                        Town
                        <input type="text" class="form-control form-control-sm" style="width: 180px; display: inline;"
                            id="town" value="{{ $town != null ? $town->Town : '' }}">
...
@push('page_scripts')
    ...
    <script>
        ...
        mapboxgl.accessToken =
            'pk.eyJ1IjoianVsemxvcGV6IiwiYSI6ImNqZzJ5cWdsMjJid3Ayd2xsaHcwdGhheW8ifQ.BcTcaOXmXNLxdO3wfXaf5A';
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                location.href =
                                    "{{ route('serviceAccounts.pending-accounts') }}"
                            }
                        })
        ...
        function loadServiceConnectionGPS() {
            ...
            if (!jQuery.isEmptyObject(meterLoc)) {
                ...
                if (meterSplit.length == 2) {
                    ...
                    el.innerHTML +=
                        '<button id="update" class="btn btn-sm" style="margin-left: -10px;" style="margin-left: 10px;"> <span><i class="fas fa-map-marker-alt text-danger" style="font-size: 2.4em;"></i></span> </button>'
                        ...
                        $.each(res, function(index, element) {
                            if (!jQuery.isEmptyObject(res[index]['Item1'])) {
                                ...
                                if (loc.length == 2) {
                                    ...
                                    el.className = 'marker';
                                    el.id = "neighbors";
                                    el.title = res[index]['AccountNumber'] + " | " + res[index][
                                        'ConsumerName'
                                    ]
                                    el.innerHTML +=
                                        '<button id="update" class="btn btn-sm" style="margin-left: -10px;" style="margin-left: 10px;"> <span><i class="fas fa-map-marker-alt text-primary" style="font-size: 2.2em;"></i></span> </button>'
                                    el.style.backgroundColor = `transparent`;
                                    el.style.width = `15px`;
                                    el.style.height = `15px`;
                                    el.style.borderRadius = '50%';
