...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-5">
                    <h4>{{ $accountMaster->ConsumerName }}</h4>
                </div>
                <div class="col-sm-7">
                    @if (Auth::user()->hasAnyRole(['Administrator', 'Heads and Managers', 'Data Administrator'])) 
                        @if ($accountMaster->AccountStatus == 'APPREHENDED')
                        
                        @else
                            @if ($accountMaster->AccountStatus == 'PULLOUT')
                            ...
                            @if ($accountMaster->AccountStatus == 'DISCO')
                                
                            @elseif ($accountMaster->AccountStatus == 'ACTIVE')
    ...
    <div class="content px-3">
        <div class="row">
            <div class="col-lg-4 col-md-5">
                @include('account_masters.account_info')
            </div>
                    ...
                    <div class="card-body px-0">
                        <div class="tab-content">
                            <div class="tab-pane active" id="billing-hist">
                                @include('account_masters.tab_power_bills_ledger')
                            </div>
