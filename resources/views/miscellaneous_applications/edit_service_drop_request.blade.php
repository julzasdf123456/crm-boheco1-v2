...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4>Edit Service Drop Purchase Request</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('miscellaneousApplications.edit-service-drop-purchasing', [$miscellaneousApplication->id]) }}">Edit
                                SDPR</a></li>
                    </ol>
                </div>
            </div>
            ...
            <div class="card shadow-none">
                ...
                <div class="card-body">
                    ...
                    <form class="row" method="POST"
                        action="{{ route('miscellaneousApplications.update-service-drop-purchase') }}">
                        @csrf
                        <input type="hidden" name="id" value="{{ $miscellaneousApplication->id }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-7">
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('ConsumerName', $miscellaneousApplication->ConsumerName, [
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-7">
                                    <div class="input-group">
                                        ...
                                        {!! Form::select('Town', $towns, $selectedTown, ['class' => 'form-control form-control-sm', 'required' => 'true']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-7">
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" id="selectedBarangay" value="{{$miscellaneousApplication->Barangay}}"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-7">
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('Sitio', $miscellaneousApplication->Sitio, [
                                            'class' => 'form-control form-control-sm',
                                            'maxlength' => 1000,
                                            'maxlength' => 1000,
                                            'placeholder' => 'Sitio',
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-7">
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('Notes', ($miscellaneousApplication->Notes != null) ? $miscellaneousApplication->Notes : '', [
                                            'class' => 'form-control form-control-sm',
                                            'maxlength' => 1000,
                                            'maxlength' => 1000,
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-7">
                                    <div class="input-group">
                                        ...
                                        {!! Form::number('ServiceDropLength', $miscellaneousApplication->ServiceDropLength, [
                                            'class' => 'form-control form-control-sm',
                                            'step' => 'any',
                                            'required' => true,
                                            'maxlength' => 1000,
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-7">
                                    <div class="input-group">
                                        ...
                                        {!! Form::number('PricePerQuantity', $miscellaneousPayment->PricePerQuantity, [
                                            'class' => 'form-control form-control-sm',
                                            'step' => 'any',
                                            'required' => true,
                                            'maxlength' => 1000,
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-7">
                                    <div class="input-group">
                                        ...
                                        {!! Form::number('TotalAmount', $miscellaneousApplication->TotalAmount, [
                                            'class' => 'form-control form-control-sm',
                                            'step' => 'any',
                                            'readonly' => true,
                                            'maxlength' => 1000,
