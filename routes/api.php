...
Route::get('get-accounting-sales-invoice-batch', [SAPAPI::class, 'getAccountingServiceInvoiceBatch']);
Route::get('get-accounting-incoming-payment-batch', [SAPAPI::class, 'getAccountingIncomingPaymentBatch']);
