...
class ServiceConnectionEnergizationReportExportNew implements FromArray, ShouldAutoSize, WithColumnFormatting, WithHeadings, WithStyles, WithEvents, WithCustomStartCell {
